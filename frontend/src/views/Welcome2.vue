    ...
    <div class="page-content">
      <header class="welcome-header">
        <div class="header-tags">
          ...
          <mc-tag appearance="success" fit="small" label="Service Model Analytics" />
        </div>
        <h1 class="welcome-title">Welcome</h1>
        <p class="welcome-subtitle">
          Choose a tool below to manage migrations, reporting, and learning — enhanced with Future Service Model
          insights from integrated cost, readiness, and country-level analytics.
        </p>
        <router-link class="classic-link" to="/">
          <mc-button appearance="neutral" variant="plain" fit="small" label="View classic Welcome" icon="mi-arrow-left" />
        </router-link>
      </header>
...
import Welcome2Analytics from '../components/welcome2/Welcome2Analytics.vue'
