  ...
  <div class="po-page">
    <div class="po-page-inner">
      ...
      <div v-if="loading && !hotReady" class="table-loading">
        ...
        <span>Loading product ownership…</span>
      </div>
      ...
      <mc-dialog
        :open="helpDialogOpen"
        heading="Product Ownership — User Guide"
        dimension="medium"
        showclosebutton
      ...
      >
        <div class="help-dialog-body">
          <section class="help-section">
            ...
            <p>
              Maintain the mapping between <strong>Product</strong>, <strong>Manager</strong>,
              <strong>Region</strong>, and <strong>Migration Manager</strong>. Edit cells, add or
...
const ALL_COLUMNS = [
  { key: 'product', label: 'Product', width: 320 },
  { key: 'manager', label: 'Manager', width: 200 },
