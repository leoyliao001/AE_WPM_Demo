  ...
  @each $variant in $variants {
    @if $variant == 'default' {
      .mds-#{$appearance}__#{$type}-color {
        ...
        @example:
        <div class="mds"><div class="mds-#{$appearance}__#{$type}-color">#{$type} color in #{$appearance} appearance</div></div>
        */
      ...
      .mds-#{$appearance}--#{$variant}__#{$type}-color {
        ...
        @example:
        <div class="mds"><div class="mds-#{$appearance}--#{$variant}__#{$type}-color">#{$type} color in #{$appearance} #{$variant} appearance</div></div>
        */
        @include mds-generate-color-properties($appearance, $variant, $type);
      }
    }
  ...
  @each $variant in $variants {
    @if $variant == 'default' {
      ...
      a.mds-#{$appearance}__#{$type}-color:visited {
        ...
        @category: Hyperlink
        @usage: 
        Use mds-#{$appearance}__#{$type}-color class to get hyperlink to have the #{$appearance} color.
        @example:
        <a class="mds-#{$appearance}__#{$type}-color">#{$type} color in #{$appearance} appearance</a>
        */
        @include mds-generate-color-properties($appearance, $variant, $type);
      }
    } @else {
      ...
      a.mds-#{$appearance}--#{$variant}__#{$type}-color:visited {
        ...
        @category: Hyperlink
        @usage: 
        Use mds-#{$appearance}--#{$variant}__#{$type}-color class to get hyperlink to have the #{$appearance} #{$variant} color.
        @example:
        <a class="mds-#{$appearance}--#{$variant}__#{$type}-color">#{$type} color in #{$appearance} #{$variant} appearance</a>
        */
        @include mds-generate-color-properties($appearance, $variant, $type);
      }
    }
