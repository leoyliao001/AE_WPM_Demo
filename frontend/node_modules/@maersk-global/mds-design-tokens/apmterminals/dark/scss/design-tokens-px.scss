...
$mds_brand_typography_headline_font-family: 'Maersk Text';
...
$mds_brand_typography_headline_x-small_font-weight: 300;
...
$mds_brand_typography_headline_small_font-weight: 300;
...
$mds_brand_appearance_neutral_default_text-color: rgb(236,236,237);
$mds_brand_appearance_neutral_default_background-color: rgb(20,20,20);
$mds_brand_appearance_neutral_default_on-background-color: rgb(236,236,237);
$mds_brand_appearance_neutral_default_border-color: rgb(120,120,120);
$mds_brand_appearance_neutral_default_opacity_border-color: rgba(255,255,255,0.43);
$mds_brand_appearance_neutral_weakest_text-color: rgb(152,152,152);
$mds_brand_appearance_neutral_weakest_background-color: rgb(36,36,42);
$mds_brand_appearance_neutral_weakest_on-background-color: rgb(236,236,237);
$mds_brand_appearance_neutral_weak_text-color: rgb(207,207,207);
$mds_brand_appearance_neutral_weak_background-color: rgb(48,48,56);
$mds_brand_appearance_neutral_weak_on-background-color: rgb(236,236,237);
$mds_brand_appearance_neutral_weak_border-color: rgb(58,58,58);
$mds_brand_appearance_neutral_weak_opacity_background-color: rgba(255,255,255,0.12);
$mds_brand_appearance_neutral_strong_background-color: rgb(60,60,70);
$mds_brand_appearance_neutral_strong_on-background-color: rgb(236,236,237);
$mds_brand_appearance_neutral_strongest_background-color: rgb(138,138,144);
$mds_brand_appearance_neutral_strongest_on-background-color: rgb(24,24,28);
...
$mds_brand_appearance_neutral_inverse_on-background-color: rgb(24,24,28);
$mds_brand_appearance_neutral_inverse_border-color: rgb(20,20,20);
$mds_brand_appearance_primary_default_text-color: rgb(255,128,51);
$mds_brand_appearance_primary_default_background-color: rgb(255,128,51);
$mds_brand_appearance_primary_default_on-background-color: rgb(20,20,20);
$mds_brand_appearance_primary_default_border-color: rgb(255,128,51);
$mds_brand_appearance_primary_default_link-color: rgb(255,128,51);
$mds_brand_appearance_primary_weak_background-color: rgb(136,51,0);
$mds_brand_appearance_primary_weak_on-background-color: rgb(255,239,230);
$mds_brand_appearance_primary_weak_border-color: rgb(136,51,0);
$mds_brand_appearance_secondary_default_text-color: rgb(157,197,205);
$mds_brand_appearance_secondary_default_background-color: rgb(157,197,205);
$mds_brand_appearance_secondary_default_on-background-color: rgb(20,20,20);
$mds_brand_appearance_secondary_default_border-color: rgb(157,197,205);
$mds_brand_appearance_secondary_weak_background-color: rgb(6,70,83);
$mds_brand_appearance_secondary_weak_on-background-color: rgb(231,241,243);
$mds_brand_appearance_secondary_weak_border-color: rgb(6,70,83);
...
$mds_brand_appearance_state_neutral_default_hover_background-color: rgb(36,36,42);
$mds_brand_appearance_state_neutral_default_hover_border-color: rgb(177,177,181);
$mds_brand_appearance_state_neutral_default_active_background-color: rgb(48,48,56);
$mds_brand_appearance_state_neutral_default_active_border-color: rgb(216,216,218);
$mds_brand_appearance_state_neutral_weakest_opacity_hover_background-color: rgba(255,255,255,0.12);
$mds_brand_appearance_state_neutral_weakest_opacity_active_background-color: rgba(255,255,255,0.2);
...
$mds_brand_appearance_state_neutral_strongest_hover_background-color: rgb(177,177,181);
$mds_brand_appearance_state_neutral_strongest_active_background-color: rgb(216,216,218);
$mds_brand_appearance_state_neutral_inverse_opacity_hover_background-color: rgba(60,60,70,0.08);
$mds_brand_appearance_state_neutral_inverse_opacity_active_background-color: rgba(60,60,70,0.2);
$mds_brand_appearance_state_primary_default_hover_background-color: rgb(255,96,0);
$mds_brand_appearance_state_primary_default_hover_border-color: rgb(255,96,0);
$mds_brand_appearance_state_primary_default_active_background-color: rgb(204,77,0);
$mds_brand_appearance_state_primary_default_active_border-color: rgb(204,77,0);
$mds_brand_appearance_state_primary_weakest_opacity_hover_background-color: rgba(255,128,51,0.14);
$mds_brand_appearance_state_primary_weakest_opacity_active_background-color: rgba(255,128,51,0.22);
$mds_brand_appearance_state_secondary_default_hover_background-color: rgb(10,110,130);
$mds_brand_appearance_state_secondary_default_active_background-color: rgb(8,88,104);
$mds_brand_appearance_state_secondary_weakest_opacity_hover_background-color: rgba(59, 139, 155, 0.2);
$mds_brand_appearance_state_secondary_weakest_opacity_active_background-color: rgba(59, 139, 155, 0.28);
...
$mds_brand_appearance_state_focus_border-color: rgb(108,168,180);
...
$mds_brand_appearance_state_focus_default_shadow_color: rgb(8,88,104);
...
$mds_brand_appearance_state_focus_vanity_shadow_color: rgb(8,88,104);
$mds_brand_appearance_state_disabled_opacity: 0.5;
$mds_foundations_body_background-color: rgb(20,20,20);
$mds_foundations_body_text-color: rgb(236,236,237);
$mds_foundations_breadcrumb_item_text-color: rgb(207,207,207);
$mds_foundations_breadcrumb_item_padding: 6px;
$mds_foundations_breadcrumb_separator_text-color: rgb(152,152,152);
...
$mds_foundations_horizontal-rule_border-color: rgb(120,120,120);
...
$mds_foundations_link_default_text-color: rgb(255,128,51);
...
$mds_foundations_modal_footer_background-color: rgb(36,36,42);
...
$mds_foundations_table_border-color: rgb(120,120,120);
...
$mds_foundations_table_cell_text-color: rgb(236,236,237);
$mds_foundations_table_cell_hover_background-color: rgb(36,36,42);
$mds_foundations_table_cell_hover_text-color: rgb(236,236,237);
$mds_foundations_table_cell_selected_background-color: rgb(136,51,0);
$mds_foundations_table_cell_selected_text-color: rgb(255,239,230);
$mds_foundations_table_header-cell_sort-button_font-weight: 700;
$mds_foundations_table_header-cell_background-color: rgb(36,36,42);
$mds_foundations_table_header-cell_text-color: rgb(236,236,237);
$mds_foundations_table_header-cell_sort_hover_background-color: rgb(36,36,42);
$mds_foundations_table_header-cell_sort_active_background-color: rgb(48,48,56);
$mds_foundations_table_zebra-stripe_background-color: rgb(36,36,42);
$mds_foundations_table_zebra-stripe_text-color: rgb(236,236,237);
$mds_foundations_table_caption_text-color: rgb(236,236,237);
$mds_foundations_table_subtext_text-color: rgb(207,207,207);
