...
export type MouseMoveVisibleArea = {
    min: number;
    max: number;
};
export interface IMcList {
    ...
    /**
     * The data to be displayed in the list. It is an array of objects`<IMcListDataItem>`
     * @type IMcListDataItem[{ label: string; value: string | number; disabled?: boolean }] }
     * @example
     * [
     *   { label: 'apple', value: '1', disabled: true },
     *   { label: 'strawberry', value: '2', disabled: false },
     * ]
     */
    data?: IMcListDataItem[] | null;
}
export interface IMcListDataItem {
    /**
