...
export interface IMcButton extends IMcTextAndIcon {
    ...
    border?: ButtonBorder;
    /**
     * Whether the button should have fully rounded corners.
     */
    rounded?: boolean;
    /**
    ...
    /**
     * Sets the `aria-expanded` on the inner button in cases like tab where the button is expanded in a list and at the same time,
     * the currently expanded item needs to be specified.
     */
