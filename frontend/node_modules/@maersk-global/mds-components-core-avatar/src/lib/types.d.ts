...
export interface IMcAvatar {
    ...
    /**
     * If set, the avatar will get a pointer cursor and will be accessible via keyboard navigation. You can then listen to the `click` event to handle the click event, optionally handle you application router and redirects.
     */
    clickable?: boolean;
    /**
