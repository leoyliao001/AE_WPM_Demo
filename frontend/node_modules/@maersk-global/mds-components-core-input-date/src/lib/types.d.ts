import { CellCustomizationPayload, Fit, IMcValidation, LabelPosition, Position, Variant } from '@maersk-global/mds-shared-types';
...
export declare const INPUT_DATE_DEFAULTS: IMcInputDateDefaults;
