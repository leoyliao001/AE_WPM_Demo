...
type LoadingIndicatorAppearanceNew = 'primary' | 'neutral-inverse' | 'success' | 'warning' | 'error';
...
export interface IMcLoadingIndicator {
    ...
    hiddenlabel?: boolean;
    /**
     * Extra aria-label that should be used for accessibility purposes.
     * If not provided, the `label` property will be used as `aria-label`
     */
    arialabel?: string;
    /**
