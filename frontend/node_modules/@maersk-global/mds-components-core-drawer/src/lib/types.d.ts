import type { BreakpointSizes, CustomSize, IMcDialog } from '@maersk-global/mds-components-core-dialog/types';
export type { BreakpointSizes, CustomSize, IMcDialog } from '@maersk-global/mds-components-core-dialog/types';
...
export interface IMcDrawer extends IMcDialog {
    /**
     * Opens the drawer.
     * @type {boolean}
     **/
