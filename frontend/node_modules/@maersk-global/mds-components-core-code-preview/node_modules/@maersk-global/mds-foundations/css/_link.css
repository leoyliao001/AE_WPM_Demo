...
a.mds-link--stand-alone:hover, a.mds-link--stand-alone:active {
  text-decoration: var(--mds_foundations_link_stand-alone_hover_text-decoration);
}
a.mds-link--stand-alone:visited {
  text-decoration: var(--mds_foundations_link_stand-alone_text-decoration);
}
a.mds-link--disabled {
  /*
...
a.mds-link--disabled:hover {
  text-decoration: var(--mds_foundations_link_inline_text-decoration);
}
a.mds-link--disabled:hover.mds-link--stand-alone {
  text-decoration: var(--mds_foundations_link_stand-alone_text-decoration);
}
a.mds-link--disabled {
  pointer-events: none;
...
a.mds-link--focus-shadow-inset:focus-visible {
  outline: 0;
